...
def Get12Hemispheres_generic():
	...
	vec = Normalize[1, 0, 0]
  	...
  	return(rotationMatrix_generic(theta,vec),rotationMatrix_generic(theta,-vec),rotationMatrix_generic(theta,vec2),rotationMatrix_generic(theta,-vec2),rotationMatrix_generic(theta,vec3),rotationMatrix_generic(theta,-vec3),rotationMatrix_generic(theta,vec4),rotationMatrix_generic(theta,-vec4),rotationMatrix_generic(theta,vec5),rotationMatrix_generic(theta,-vec5),rotationMatrix_generic(theta,vec6),rotationMatrix_generic(theta,-vec6))
