...
def compute_reflection_clusters_GP(reflected_signals):
    hemispheres = Hemisphere.get_12_hemispheres() #Change to Hemisphere.get_x_hemispheres() where x is element of {3,4,6,12} if needed.
